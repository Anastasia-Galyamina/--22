        ...
        where T : class, ITransport
    {
        ...
        public int CompareTo(Parking<T> other)
        {
            ...
            else if (_places.Count > 0)
            {
                ...
                {
                    if (_places[thisKeys[i]] is Ship && other._places[thisKeys[i]] is MotorShip)
                    {
                        return 1;
                    }
                    if (_places[thisKeys[i]] is MotorShip && other._places[thisKeys[i]] is Ship)
                    {
                        return -1;
                    }
                    ...
                    if (_places[thisKeys[i]] is MotorShip && other._places[thisKeys[i]]
                    is MotorShip)
                    {
                        return (_places[thisKeys[i]] is
                       MotorShip).CompareTo(other._places[thisKeys[i]] is MotorShip);
                    }
                }
            }
            return 0;
